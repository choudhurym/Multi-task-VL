...
if __name__ == '__main__':
    ...
    import os
    import sys
    ROOT_DIR = os.path.join(os.path.join(os.path.dirname(__file__), '..', '..'))
    sys.path.insert(0, os.path.join(ROOT_DIR, 'lib', 'datasets'))
    ...
    ref_id = 49767
    print("GD: %s".format(refer.Refs[ref_id]['sentences']))
    ...
    for metric, score in refEval.eval.items():
        print('%s: %.3f'.format(metric, score))
